...
class BounceController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(BounceController.taptap))
    ...
    internal func startTimer(){
        ...
        // Run Animation Loop
        pTimer = Timer.scheduledTimer(timeInterval: 0.001, target: self, selector: #selector(BounceController.animation), userInfo: nil, repeats: true)
    }
